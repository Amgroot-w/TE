...
for i in range(6):
    ...
    model = TE.LSTM_DAE(input_num=52, hidden_num=20, output_num=52,
    ...
    with graph[i].as_default():
        ...
        # 模型保存路径
        model_path1 = "D:\\Python Codes\\TE\\TE_SaveMulti\\FeatureLSTM/SaveFeatureLSTM.ckpt"
        # 训练
...
# %% 训练分类器
ClassifyModel = TE.NeuralNetwork(input_num=20, hidden_num=10, output_num=6,
                                 learning_rate=0.05, epochs=1000, decay_steps=100, decay_rate=0.6,
